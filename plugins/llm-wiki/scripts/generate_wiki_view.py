...
# ── sibling scripts/ on sys.path (same idiom as the marker hook / conftest) ──
SCRIPT_DIR = Path(__file__).resolve().parent
if str(SCRIPT_DIR) not in sys.path:
    sys.path.insert(0, str(SCRIPT_DIR))

import link_lint   # noqa: E402  REUSE extract_links / build_graph / page_name
import marker      # noqa: E402  REUSE marker.detect (wiki-root check)
import wiki_index  # noqa: E402  REUSE scan_pages / tier_of
import wiki_root_resolver  # noqa: E402  REUSE resolve() (multi-scope wiki-root)

import markdown    # noqa: E402  (PEP723 inline dep)
