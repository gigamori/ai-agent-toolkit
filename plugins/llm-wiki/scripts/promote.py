...
This module mutates the working tree; the caller runs it inside the single git
transaction (transaction.py) so a failed promote rolls back cleanly.
"""
